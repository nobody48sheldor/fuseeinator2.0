...
def main():
    ...
    p1 = executor.submit(func.hvfp_, n, func.fp)
    p2 = executor.submit(func.high, vfp, dt)
    p3 = executor.submit(func.vvfp_, n, func.fp)
    p4 = executor.submit(func.speed, vfp, dt)
    p5 = executor.submit(func.hmax)
